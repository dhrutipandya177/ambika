    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <h5 class="page-title">Category Listing</h5>
            </div>
        </div>
                ...
                <div class="card m-b-30">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-2">
                                <a class="btn btn-success" href="{{ route('categories.create') }}" role="button">Add New Category</a>
                            </div>
                        </div>
    ...
    <script>
      $(document).ready(function(){
        oTable=$('#categories_table').DataTable({
          ...
          ajax : "{{ route('categories.getparentcategories') }}",
          columns: [
            //{data:'id',name:'id'},
      ...
      function deletecat(catid){
      	var baseUrl = "{{ route('categories.index') }}";
