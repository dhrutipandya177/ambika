            ...
            <div class="col-6">
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <form name="category-create" id="category-create" method="POST" action="{{ route('subcategories.update') }}" class="form-validate" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="parent_id" class="form-control" required>
                                        @foreach($categories as $maincategory)
                                            <option value="{{ $maincategory['id'] }}" {{ ( $maincategory['id'] == $category[0]['parent_id']) ? 'selected' : '' }}>{{ $maincategory['name'] }}</option>
                                        @endforeach
                                    </select>    
                                </div>
                            @endif
