    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <h5 class="page-title">Add New Order</h5>
            </div>
        </div>
            ...
            <div class="col-6">
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <form name="order-create" id="order-create" method="POST" action="{{ route('orders.store') }}" class="form-validate" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <a href="{{ route('orders.index') }}" class="btn btn-secondary waves-effect m-l-5">
                                        Cancel
                                    </a>
                                </div>
                            </div>
